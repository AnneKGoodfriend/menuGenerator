...
`.forEach()` is a method that we can use to iterate through an array in place of a `for loop` that makes our code much more readable while removing room for errors.  
